...
import com.portal.common.util.PtrCLog;
...
//                    && Math.abs(offsetX) > (float)this.mPagingTouchSlop
                    if(this.mDisableWhenHorizontalMove && !this.mPreventForHorizontal  && Math.abs(offsetX) > Math.abs(offsetY) && this.mPtrIndicator.isInStartPosition()) {
                    ...
                    if(this.mPreventForHorizontal) {
                        ...
                        boolean canFooterMoveUp = this.mPtrHandler != null && this.mFooterView != null && this.mPtrHandler instanceof PtrHandler2 && ((PtrHandler2)this.mPtrHandler).checkCanDoLoadMore(this, this.mContent, this.mFooterView) && (this.mMode.ordinal() & 2) > 0;
                        if(DEBUG) {
    ...
    public void setFooterView(View footer) {
        if(this.mFooterView != null && footer != null && this.mHeaderView != footer) {
            this.removeView(this.mHeaderView);
        }
