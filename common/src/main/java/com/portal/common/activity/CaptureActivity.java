...
import com.portal.common.qrcode.CameraManager;
import com.portal.common.qrcode.CameraPreview;
import com.portal.common.qrcode.QRCodeDecoder;
...
public class CaptureActivity extends Activity {
    ...
    private ProgressBar capture_scan_loading;
    ...
    private void findViewById() {
        ...
        capture_scan_loading = findViewById(R.id.capture_scan_loading);
		findViewById(R.id.back_cap).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
                onBackPressed();
			}
		});
		findViewById(R.id.scan_top).setOnClickListener(
				new OnClickListener() {
            ...
            if(requestCode == 10005){
                if (null != data) {
                    ...
                    if (c != null) {
                        ...
                        capture_scan_loading.setVisibility(View.VISIBLE);
                        stopScan();
                        new AsyncTask<Void, Void, String>() {
                            ...
                            protected void onPostExecute(String result) {
                                capture_scan_loading.setVisibility(View.GONE);
                                startScan();
                                if (TextUtils.isEmpty(result)) {
                                    UtilToast.show(CaptureActivity.this, "图片二维码识别错误");
                                } else {
                                    previewing = false;
